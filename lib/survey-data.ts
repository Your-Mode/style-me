export const surveyQuestions = [
  ...
  },
  {
    ...
    options: [
      {
        value: 'A',
        label: '전체적으로 근육이 잘 느껴지고, 근육이 잘 붙는 편이다',
        type: 'straight',
      },
      {
        value: 'B',
        label: '전체적으로 지방이 잘 느껴지고, 근육이 잘 붙지 않는 편이다',
        type: 'wave',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'C',
        label: '살이나 근육이 잘 붙지 않으며, 몸 전체에 고르게 살이 붙는 편이다',
        type: 'natural',
      },
    ],
    chatbotResponse: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'B',
        label: '목이 가늘고 긴 편이며 승모근이 크게 부각되지 않는 편이다',
        type: 'wave',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'C',
        label: '바스트보다 가슴 주변(쇄골, 갈비뼈 등) 뼈가 부각되는 편이다',
        type: 'natural',
      },
    ],
    chatbotResponse: {
  ...
  },
  {
    ...
    options: [
      {
        value: 'A',
        label: '무릎 뼈가 작고 둥글며, 뼈가 눈에 잘 띄지 않는 편이다',
        type: 'straight',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'C',
        label: '손가락이 길고 가늘며, 뼈와 핏줄 등이 눈에 띄는 편이다',
        type: 'natural',
      },
    ],
    chatbotResponse: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 'B',
        label: '하체가 상대적으로 부각되며 전체적으로 여리여리한 느낌이다',
        type: 'wave',
      },
      {
        value: 'C',
        label: '전체적으로 뼈가 도드라져보이고 직선적인 느낌이 강하다',
        type: 'natural',
      },
    ],
    chatbotResponse: {
